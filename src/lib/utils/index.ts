...
export const promptTemplate = (
	...
	// Use replaceAll to catch any multiple occurrences and ensure we never send empty strings
	template = template.replaceAll('{{CURRENT_TIMEZONE}}', currentTimezone || 'UTC');
